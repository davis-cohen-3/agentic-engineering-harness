...
- **Docs** = `AGENTS.md`, `agent_docs/**`, `README*`, and contract docs under `specs/**`.
...
1. **Layout** — the directory/layer map in `AGENTS.md` / `agent_docs/architecture.md` vs the real tree.
