...
|-------|--------|--------|---------|---------------|
| `grill` | mattpocock/skills · `skills/productivity/grill-me` | be55a79 | MIT © Matt Pocock | + local sections "Ground the grilling in this codebase" (→ `docs/`) and "Record the thread" (→ `.workspace/LOG.md`); + a `STARTER_CHARACTER` marker line (🔥) |
