---
name: tdd
description: Test-driven development (TDD) process — red/green/refactor for new logic. Use when implementing new feature behavior or non-trivial logic worth a test. NOT for trivial/mechanical edits, config or docs, pure refactors of tested code, or exploratory spikes — and skip if the user explicitly asks to skip TDD.
---
